...
export const MobileBottomNav: React.FC<MobileBottomNavProps> = ({ onNavigate, activePage }) => {
  ...
  return (
    <div id="mobile-bottom-nav" className="md:hidden fixed bottom-0 left-0 right-0 z-30 bg-white/80 dark:bg-[#070b14]/90 backdrop-blur-2xl border-t border-slate-200/50 dark:border-white/5 shadow-[0_-8px_40px_rgba(0,0,0,0.12)]" style={{ paddingBottom: 'max(12px, env(safe-area-inset-bottom))' }}>
